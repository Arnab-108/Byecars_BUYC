...
export const Form = () => {
    //Wanted to use Redux but time was running out. So had to do it this way
    ...
    const [kms_ran , setKmsran] = useState("")
    const [major_scratches , setMajorScratch] = useState("")
    const [accidents , setAccidents] = useState("")
    const [max_speed,setmaxSpeed] = useState("")
    const [meilage,setMeilage] = useState("")
    const [org_paint , setOrgpaint] = useState("")
    const [prev_byer , setPrevByer] = useState("")
                ...
                <Box
                  ...
                  <VStack spacing={5}>
                    ...
                    <FormControl isRequired>
                      ...
                      <InputGroup>
                        <InputLeftElement children={<BsPerson />} />
                        <Input type="text" name="image" placeholder="Color" 
                        value={color} 
                    ...
                    <FormControl isRequired>
                      ...
                      <InputGroup>
                        <InputLeftElement children={<BsPerson />} />
                        <Input type="number" name="image" placeholder="Kilometers Ran" 
                        value={kms_ran} 
                        onChange={(e)=>{setKmsran(e.target.value)}} 
                        />
                      </InputGroup>
                    </FormControl>
                    <FormControl isRequired>
                      ...
                      <InputGroup>
                        <InputLeftElement children={<BsPerson />} />
                        <Input type="number" name="image" placeholder="Major Scratches" 
                        value={major_scratches} 
                        onChange={(e)=>{setMajorScratch(e.target.value)}} 
                        />
                      </InputGroup>
                    </FormControl>
                    <FormControl isRequired>
                      ...
                      <InputGroup>
                        <InputLeftElement children={<BsPerson />} />
                        <Input type="number" name="image" placeholder="Accidents if any" 
                        value={accidents} 
                    ...
                    <FormControl isRequired>
                      ...
                      <InputGroup>
                        <InputLeftElement children={<BsPerson />} />
                        <Input type="number" name="image" placeholder="Maximum Speed" 
                        value={max_speed} 
                    ...
                    <FormControl isRequired>
                      ...
                      <InputGroup>
                        <InputLeftElement children={<BsPerson />} />
                        <Input type="number" name="image" placeholder="Mileage" 
                        value={meilage} 
                        onChange={(e)=>{setMeilage(e.target.value)}} 
                        />
                      </InputGroup>
                    </FormControl>
                    <FormControl isRequired>
                      ...
                      <InputGroup>
                        <InputLeftElement children={<BsPerson />} />
                        <Input type="text" name="image" placeholder="Original Paint" 
                        value={org_paint} 
                    ...
                    <FormControl isRequired>
                      ...
                      <InputGroup>
                        <InputLeftElement children={<BsPerson />} />
                        <Input type="number" name="image" placeholder="Price" 
                        value={price} 
                    ...
                    <FormControl isRequired>
                      ...
                      <InputGroup>
                        <InputLeftElement children={<BsPerson />} />
                        <Input type="text" name="image" placeholder="Previous Byer" 
                        value={prev_byer} 
                        onChange={(e)=>{setPrevByer(e.target.value)}} 
                        />
                      </InputGroup>
                    </FormControl>
                    <FormControl isRequired>
                      ...
                      <InputGroup>
                        <InputLeftElement children={<BsPerson />} />
                        <Input type="text" name="image" placeholder="Registered Place" 
                        value={rgst_place} 
                        onChange={(e)=>{setRgstplace(e.target.value)}} 
                        />
                      </InputGroup>
                    </FormControl>
