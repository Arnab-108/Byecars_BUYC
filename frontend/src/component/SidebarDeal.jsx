...
export const SidebarDeal = () => {
    ...
    const handleMeilage=(e)=>{
        let newMeilage = [...meilage]
        const value = e.target.value
        if(newMeilage.includes(value)){
            newMeilage = newMeilage.filter((el)=> el!==value)
        }
        else{
            newMeilage.push(value)
        }
        setMeilage(newMeilage)
    }
